...
(function() {
  ...
  WorldModel = (function() {
    ...
    WorldModel.prototype.collide = function(x, y) {
      var c, d, dis, dv1, dv2, i, left, m1, m2, normal, overlap, p1, p2, tangent, v1, v1a, v1b, v1c, v2, v2a, v2b, v2c, _i;
      if (!x.r) {
        return;
      }
      if (!y.r) {
      ...
      if (left) {
        ...
        return y.p = Vector2d.add(y.p, Vector2d.multiply(x.v, left / c));
      }
    };
