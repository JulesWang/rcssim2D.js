...
(function() {
  ...
  Pitch = (function() {
    ...
    Pitch.prototype.playon_rules = function() {
      ...
      x = this.wm.ball.p[0];
      y = this.wm.ball.p[1];
      if (Math.abs(y) < this.goal_width / 2 - this.wm.ball.r) {
    ...
    Pitch.prototype.is_goal = function(ball, l1, l2) {
      ...
      if ((x - u1) * (x - u2) <= 0 && (y - v1) * (y - v2) <= 0 && (x2 - x1) * u1 > 0) {
        this.auto_kickoff = true;
        this.kickoff_delay = 50;
        return true;
      }
  ...
  WorldModel = (function() {
    ...
    WorldModel.prototype.collide = function(x, y) {
      var c, d, dis, dv1, dv2, e, i, left, m1, m2, normal, overlap, p1, p2, tangent, v1, v1a, v1b, v1c, v2, v2a, v2b, v2c, _i;
      ...
      left = 0;
      c = 10;
      for (i = _i = 1; 1 <= c ? _i <= c : _i >= c; i = 1 <= c ? ++_i : --_i) {
      ...
      if (left) {
        ...
        return y.p = Vector2d.add(y.p, Vector2d.multiply(y.v, left / c));
      }
    };
  ...
  main = function() {
    ...
    start_game = function() {
      ...
      if (debug) {
        if (debug) {
          left = debug_left_team;
        }
        if (debug) {
          right = debug_right_team;
        }
      } else {
