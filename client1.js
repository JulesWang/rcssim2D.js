...
(function() {
  var Athom, BALL_R, Bar, Fmt235, Fmt442, Fmt523, Foo, GOAL_WIDTH, Gao, HALF_GOAL_WIDTH, MAX_DASH_FORCE, MAX_KICK_FORCE, MY_GOAL_POS, OP_GOAL_POS, PENALTY_AREA_LENGTH, PENALTY_AREA_WIDTH, PITCH_HALF_LENGTH, PITCH_HALF_WIDTH, PITCH_LENGTH, PLAYER_R, Vector2d, in_my_penalty, is_goalie, multiply, player_near_ball, root;
  ...
  Foo = (function() {
    ...
    Foo.prototype.go_and_kick = function(ball) {
      ...
      goal2ball = Vector2d.subtract(ball, OP_GOAL_POS);
      unit = Vector2d.unit(goal2ball);
      gopos = Vector2d.add(Vector2d.multiply(unit, BALL_R + PLAYER_R + 2.9), ball);
      ball2goal = Vector2d.subtract(OP_GOAL_POS, ball);
      angleb2g = Math.atan2(ball2goal[1], ball2goal[0]);
      me2ball = Vector2d.subtract(ball, this.mypos);
      anglem2b = Math.atan2(me2ball[1], me2ball[0]);
