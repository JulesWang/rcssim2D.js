...
(function() {
  var BALL_R, Ball, Canvas, Fmt442, Foo, GOAL_WIDTH, HALF_GOAL_WIDTH, KEY_DOWN, KEY_UP, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, K_9, K_ALT, K_BACKSPACE, K_CTRL, K_DOWN, K_ENTER, K_ESC, K_LEFT, K_RIGHT, K_SHIFT, K_SPACE, K_TAB, K_UP, K_a, K_b, K_c, K_d, K_e, K_f, K_g, K_h, K_i, K_j, K_k, K_l, K_m, K_n, K_o, K_p, K_q, K_r, K_s, K_t, K_u, K_v, K_w, K_x, K_y, K_z, MAX_DASH_FORCE, MAX_KICK_FORCE, MOUSE_DOWN, MOUSE_MOTION, MOUSE_UP, MOUSE_WHEEL, OP_GOAL_POS, PENALTY_AREA_LENGTH, PENALTY_AREA_WIDTH, PITCH_HALF_LENGTH, PITCH_HALF_WIDTH, PITCH_LENGTH, PLAYER_R, Pitch, Player, QUIT, ScoreBoard, Vector2d, WorldModel, clone, gameloop, in_my_penalty, is_goalie, mY_GOAL_POS, main, multiply, onkeydown, onmousedown, player_near_ball, root;
  ...
  ScoreBoard = (function() {
    function ScoreBoard() {
      ...
      this.left_score = 0;
      this.right_score = 0;
      this.left_teamname = "unnamed";
      this.right_teamname = "unnamed";
    ...
    ScoreBoard.prototype.render = function(canvas) {
      ...
      return canvas.drawText(this.text_color, '20px Georgia', this.state + '  ' + parseInt(this.timer / 10), 0, -canvas.h / 2 + 40);
    };
  ...
  Pitch = (function() {
    function Pitch() {
      ...
      this.last_goal_side = this.auto_kickoff = false;
    ...
    Pitch.prototype.reset = function() {
      return this.change_state('before_kickoff');
    };
  ...
  WorldModel = (function() {
    ...
    WorldModel.prototype.switch_sides = function() {
      var player, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      _ref = [this.leftplayers, this.rightplayers], this.rightplayers = _ref[0], this.leftplayers = _ref[1];
      _ref1 = this.leftplayers;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        player = _ref1[_i];
        player.side = 'left';
        player.client.side = 'left';
      }
      _ref2 = this.rightplayers;
      _results = [];
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        player = _ref2[_j];
        player.side = 'right';
        _results.push(player.client.side = 'right');
      }
      return _results;
    };
